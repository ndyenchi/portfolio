          ...
          <div className="flex gap-4">
            {contactInfo.github && (
              <a
                ...
                className="group relative w-10 h-10 rounded-lg hover:bg-blue-500 border border-border hover:border-blue-500 flex items-center justify-center transition-all hover:scale-110"
                aria-label="GitHub"
              >
                <div className="absolute inset-0 bg-blue-500/20 rounded-lg opacity-0 group-hover:opacity-100 blur transition-opacity"></div>
                <svg
                  className="relative w-5 h-5 text-text-tertiary group-hover:text-white transition-colors"
                  fill="currentColor"
                  viewBox="0 0 24 24"
                >
